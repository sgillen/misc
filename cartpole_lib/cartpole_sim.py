...
class CartPoleSim:
    """
    Encapsulates everything you need for simulation and simple state feedback of a cartpole2 in Mujoco
    ...
    abs_dir = "/Users/sgillen/work_dir/sgillen_notebooks/ICRA2019/cartpole2/"

    def __init__(self, xml_file=(abs_dir + "cartpole2.xml")):
