...
ws_list, model_list, _ = load_trials("seagul/seagul/notebooks/switching2/data_needle/longer_thresh")
ws = ws_list[-1];
model = model_list[-1]
...
ws_list, model_list, rewards = load_trials("seagul/seagul/notebooks/switching2/data_needle/long_small_strong")

smooth_bounded_curve(rewards, ax=ax[0])
ax[0].set_title('Hidden sizes: (32,32)')

ws_list, model_list, rewards = load_trials("seagul/seagul/notebooks/switching2/data_needle/less_hack")
...
# fig, ax = plt.subplots(1, 2, figsize=(16, 6))
#
# ws_list, model_list, rewards1 = load_trials("seagul/seagul/notebooks/switching2/data_needle/long_strong_big")
#
# smooth_bounded_curve(rewards1, ax=ax[0])
# ax[0].set_ylim(-75, 100)
# ax[0].set_title('First round of training')

ws_list, model_list, rewards2 = load_trials("seagul/seagul/notebooks/switching2/data_needle/less_hack")
