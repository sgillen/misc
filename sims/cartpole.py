...
class Cartpole:
    """
    Implements dynamics, animation, and control for for a simple cartpole2 pendulum.
    ...
    def control(self, t, q):
        """
        This is where you should define the control for the cartpole2, called by derivs.

        By default, implements a swingup controller for the cartpole2 based on energy shaping. Switches to an LQR to
    ...
    def derivs(self, t, q):
        """
        Implements the dynamics for our cartpole2, you need to integrate this yourself with E.G:
